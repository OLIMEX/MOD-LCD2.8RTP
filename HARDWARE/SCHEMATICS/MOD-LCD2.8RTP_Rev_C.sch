...
Wire Wire Line
	1100 6150 3300 6150
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR01
U 1 1 58EDFBB4
P 900 6850
F 0 "#PWR01" H 900 6600 50  0001 C CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR04
U 1 1 58EDFB87
P 2000 1050
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR05
U 1 1 58EDFBB6
P 2800 1700
...
$Comp
L MOD-LCD2.8RTP_Rev_C:C_Small C1
U 1 1 58EDFC31
P 2400 1150
F 0 "C1" V 2275 1150 50  0000 C CNN
F 1 "1uF/10V/10%/X5R/C0603" V 2550 1150 30  0000 C CNN
F 2 "OLIMEX_RLC-FP:C_0603_5MIL_DWS" H 2400 1150 60  0001 C CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR09
U 1 1 58EE0D93
P 3800 5250
F 0 "#PWR09" H 3800 5100 50  0001 C CNN
F 1 "+3.3V" H 3800 5400 50  0000 C CNN
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R2
U 1 1 58EE1092
P 2600 5850
F 0 "R2" V 2550 5700 50  0000 C CNN
F 1 "22R/R0603" V 2550 6200 50  0000 C CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 2600 5850 60  0001 C CNN
F 3 "" H 2600 5850 60  0000 C CNN
	1    2600 5850
	0    1    1    0   
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R3
U 1 1 58EE1098
P 2600 5950
F 0 "R3" V 2550 5800 50  0000 C CNN
F 1 "22R/R0603" V 2550 6300 50  0000 C CNN
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R4
U 1 1 58EE109E
P 2600 6050
F 0 "R4" V 2550 5900 50  0000 C CNN
F 1 "22R/R0603" V 2550 6400 50  0000 C CNN
...
Wire Wire Line
	3500 5750 3500 5850
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR07
U 1 1 58EE1189
P 3500 6200
...
Wire Wire Line
	3800 6900 3800 7050
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R6
U 1 1 58EE316C
P 4150 7050
F 0 "R6" V 4075 7050 50  0000 C CNN
F 1 "4.7k/R0603" V 4225 7050 50  0000 C CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 4150 7050 60  0001 C CNN
F 3 "" H 4150 7050 60  0000 C CNN
	1    4150 7050
	0    1    1    0   
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R5
U 1 1 58EE3383
P 3800 6800
F 0 "R5" H 3850 6825 50  0000 L CNN
F 1 "100k/R0603" H 3850 6750 50  0000 L CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 3800 6800 60  0001 C CNN
...
Wire Wire Line
	4250 6450 4350 6450
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR010
U 1 1 58EE54DE
P 4350 6450
F 0 "#PWR010" H 4350 6200 50  0001 C CNN
F 1 "GND" V 4350 6350 50  0000 R CNN
...
Wire Wire Line
	3800 6450 3800 6700
$Comp
L MOD-LCD2.8RTP_Rev_C:AR1021T-I_SS(SSOP-20) U1
U 1 1 5AD398A8
P 4850 2900
F 0 "U1" H 4850 3565 50  0000 C CNN
F 1 "NA(AR1021T-I/SS(SSOP-20))" H 4850 3474 40  0000 C CNN
F 2 "OLIMEX_IC-FP:SSOP-20W" H 4850 2900 50  0001 C CNN
...
XR
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR08
U 1 1 5AD75F83
P 3800 2100
F 0 "#PWR08" H 3800 1950 50  0001 C CNN
F 1 "+3.3V" H 3800 2250 50  0000 C CNN
...
Wire Wire Line
	5250 2500 5350 2500
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR014
U 1 1 5AD8106C
P 5400 2500
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR011
U 1 1 5AD93D54
P 4300 3500
F 0 "#PWR011" H 4300 3250 50  0001 C CNN
F 1 "GND" H 4375 3350 50  0000 R CNN
...
Wire Wire Line
	4300 2800 4300 3100
$Comp
L MOD-LCD2.8RTP_Rev_C:C_Small C2
U 1 1 5ADFF248
P 4050 2800
F 0 "C2" V 3950 2800 50  0000 C CNN
F 1 "NA(1uF/10V/10%/X5R/C0603)" V 4150 3050 30  0000 C CNN
F 2 "OLIMEX_RLC-FP:C_0603_5MIL_DWS" H 4050 2800 60  0001 C CNN
...
Wire Wire Line
	5700 2600 5250 2600
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R7
U 1 1 5AE1C324
P 4850 2100
F 0 "R7" V 4800 2275 50  0000 C CNN
F 1 "NA(20k/R0603)" V 4800 1700 50  0000 C CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 4850 2100 60  0001 C CNN
...
Wire Wire Line
	1100 5550 3800 5550
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R8
U 1 1 5AE5CEF3
P 5400 3650
F 0 "R8" H 5250 3650 50  0000 L CNN
F 1 "4.7k/R0603" V 5475 3475 40  0000 L CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 5400 3650 60  0001 C CNN
F 3 "" H 5400 3650 60  0000 C CNN
	1    5400 3650
	1    0    0    -1  
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R9
U 1 1 5AE5CF6E
P 5700 3650
F 0 "R9" H 5550 3650 50  0000 L CNN
F 1 "4.7k/R0603" V 5775 3475 40  0000 L CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 5700 3650 60  0001 C CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR013
U 1 1 5AE77C3B
P 5200 3900
F 0 "#PWR013" H 5200 3750 50  0001 C CNN
F 1 "+3.3V" V 5200 4125 50  0000 C CNN
...
Wire Wire Line
	4800 7250 4800 7400
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR012
U 1 1 5AEA6A38
P 4800 7400
F 0 "#PWR012" H 4800 7150 50  0001 C CNN
F 1 "GND" H 4875 7250 50  0000 R CNN
...
RESET
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R10
U 1 1 5AD0BFB4
P 7400 1600
F 0 "R10" H 7275 1650 50  0000 C CNN
F 1 "20k/R0603" H 7125 1550 50  0000 C CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 7400 1600 60  0001 C CNN
F 3 "" H 7400 1600 60  0000 C CNN
	1    7400 1600
	-1   0    0    -1  
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR017
U 1 1 5AD18331
P 7400 2200
F 0 "#PWR017" H 7400 1950 50  0001 C CNN
F 1 "GND" H 7475 2050 50  0000 R CNN
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR016
U 1 1 5AD2456F
P 7400 1400
F 0 "#PWR016" H 7400 1250 50  0001 C CNN
F 1 "+3.3V" H 7400 1550 50  0000 C CNN
...
Wire Wire Line
	2500 4450 2500 4550
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR020
U 1 1 5AE3DC35
P 9900 5850
F 0 "#PWR020" H 9900 5600 50  0001 C CNN
F 1 "GND" H 9975 5700 50  0000 R CNN
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR019
U 1 1 5AE71CD5
P 9900 4200
F 0 "#PWR019" H 9900 4050 50  0001 C CNN
F 1 "+3.3V" H 9900 4350 50  0000 C CNN
...
Wire Wire Line
	3500 2600 4450 2600
$Comp
L MOD-LCD2.8RTP_Rev_C:SJ2W_Closed(1-2) SJ1
U 1 1 5AE9F495
P 3300 2600
F 0 "SJ1" H 3075 2500 50  0000 L CNN
F 1 "Closed(1-2)" H 2825 2675 40  0000 L CNN
F 2 "OLIMEX_Jumpers-FP:SJ_2_SMALL_12_TIED" H 3330 2750 20  0001 C CNN
F 3 "" H 3300 2600 60  0000 C CNN
	1    3300 2600
	-1   0    0    1   
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR06
U 1 1 5AE9F57B
P 3300 2900
...
Wire Wire Line
	3800 2300 3800 2500
$Comp
L MOD-LCD2.8RTP_Rev_C:SJ2W_Closed(1-2) SJ5
U 1 1 5AEBAC81
P 7400 3200
F 0 "SJ5" H 7479 3246 50  0000 L CNN
F 1 "Closed(1-2)" H 7479 3155 50  0000 L CNN
F 2 "OLIMEX_Jumpers-FP:SJ_2_SMALL_12_TIED" H 7430 3350 20  0001 C CNN
F 3 "" H 7400 3200 60  0000 C CNN
	1    7400 3200
	1    0    0    -1  
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:SJ2W_Closed(1-2) SJ4
U 1 1 5AEBADEA
P 6800 3550
F 0 "SJ4" H 6879 3596 50  0000 L CNN
F 1 "Closed(1-2)" H 6879 3505 50  0000 L CNN
F 2 "OLIMEX_Jumpers-FP:SJ_2_SMALL_12_TIED" H 6830 3700 20  0001 C CNN
...
TXD
$Comp
L MOD-LCD2.8RTP_Rev_C:SJ2W_Closed(1-2) SJ2
U 1 1 5AF620ED
P 4800 7050
F 0 "SJ2" H 4950 7000 50  0000 C CNN
F 1 "Closed(1-2)" H 5100 7100 50  0000 C CNN
F 2 "OLIMEX_Jumpers-FP:SJ_2_SMALL_12_TIED" H 4830 7200 20  0001 C CNN
...
Wire Wire Line
	4250 7050 4600 7050
$Comp
L MOD-LCD2.8RTP_Rev_C:SJ SJ3
U 1 1 5B28D043
P 4800 4200
F 0 "SJ3" H 4800 4300 50  0000 C CNN
F 1 "open" H 4800 4125 50  0000 C CNN
F 2 "OLIMEX_Jumpers-FP:SJ" H 4808 4262 20  0001 C CNN
...
Wire Wire Line
	6900 4900 6900 5100
$Comp
L MOD-LCD2.8RTP_Rev_C:CONN_01X50 LCD1
U 1 1 58EDF962
P 900 3700
F 0 "LCD1" H 750 6300 50  0000 L CNN
F 1 "(CXT280H02H34-200P50R)+(FPV-WZB21-50-LF)" V 1050 2750 50  0000 L CNN
F 2 "OLIMEX_Connectors-FP:FPV-WZB21-50-LF" H 900 4200 50  0001 C CNN
F 3 "" H 900 4200 50  0000 C CNN
	1    900  3700
	-1   0    0    -1  
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:PWR_FLAG #FLG02
U 1 1 633563AD
P 6900 4900
F 0 "#FLG02" H 6900 4995 50  0001 C CNN
F 1 "PWR_FLAG" H 6900 5123 50  0000 C CNN
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:R_Small R1
U 1 1 58EE108C
P 2600 5750
F 0 "R1" V 2550 5600 50  0000 C CNN
F 1 "22R/R0603" V 2550 6100 50  0000 C CNN
F 2 "OLIMEX_RLC-FP:R_0603_5MIL_DWS" H 2600 5750 60  0001 C CNN
F 3 "" H 2600 5750 60  0000 C CNN
	1    2600 5750
	0    1    1    0   
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:C_Small C4
U 1 1 5AD0C088
P 7400 2000
F 0 "C4" H 7325 2075 50  0000 C CNN
F 1 "1uF/10V/10%/X5R/C0603" H 7050 1925 30  0000 C CNN
F 2 "OLIMEX_RLC-FP:C_0603_5MIL_DWS" H 7400 2000 60  0001 C CNN
F 3 "" H 7400 2000 60  0000 C CNN
	1    7400 2000
	-1   0    0    -1  
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:NS2009(MSOP-10) U2
U 1 1 63359B24
P 9600 2200
F 0 "U2" H 9600 2700 50  0000 C CNN
F 1 "NS2009(MSOP-10)" H 9600 1700 50  0000 C CNN
F 2 "OLIMEX_IC-FP:MSOP-10_Pitch-0.5mm_3.00x3.00x1.00mm" H 9600 1650 50  0001 C CNN
...
Wire Wire Line
	7800 5300 8700 5300
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR015
U 1 1 58EE26A6
P 6400 4800
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR018
U 1 1 58EE25EC
P 8700 5100
F 0 "#PWR018" H 8700 4850 50  0001 C CNN
F 1 "GND" V 8700 5000 50  0000 R CNN
...
Wire Wire Line
	7200 5100 6900 5100
$Comp
L MOD-LCD2.8RTP_Rev_C:BH10S UEXT1
U 1 1 58EE23B5
P 7500 5300
F 0 "UEXT1" H 7500 5700 60  0000 C CNN
F 1 "(P-B-V-10-LF)+(CABLE-IDC10-15CM)" H 7500 4900 50  0000 C CNN
F 2 "OLIMEX_Connectors-FP:UEXTM-SMD" H 7492 5253 60  0001 C CNN
F 3 "" H 7492 5253 60  0000 C CNN
	1    7500 5300
	1    0    0    -1  
$EndComp
Wire Bus Line
...
Wire Wire Line
	1700 6550 1700 6850
$Comp
L MOD-LCD2.8RTP_Rev_C:PWR_FLAG #FLG01
U 1 1 634BA99B
P 1700 6550
F 0 "#FLG01" H 1700 6645 50  0001 C CNN
...
$EndComp
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR02
U 1 1 634CC6EE
P 1700 6850
...
SDA
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR023
U 1 1 63673CE8
P 10800 2600
F 0 "#PWR023" H 10800 2350 50  0001 C CNN
F 1 "GND" H 10875 2450 50  0000 R CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:C_Small C5
U 1 1 63673CF4
P 10400 2050
F 0 "C5" H 10550 2050 50  0000 C CNN
F 1 "100nF/Y5V/50VDC/20%/C0603" H 10400 1850 30  0000 C CNN
F 2 "OLIMEX_RLC-FP:C_0603_5MIL_DWS" H 10400 2050 60  0001 C CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:+3.3V #PWR022
U 1 1 636DEB71
P 10800 1700
F 0 "#PWR022" H 10800 1550 50  0001 C CNN
F 1 "+3.3V" H 10800 1850 50  0000 C CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:C_Small C6
U 1 1 6370DB56
P 10800 2050
F 0 "C6" H 10950 2050 50  0000 C CNN
F 1 "1uF/10V/10%/X5R/C0603" V 10700 2050 30  0000 C CNN
F 2 "OLIMEX_RLC-FP:C_0603_5MIL_DWS" H 10800 2050 60  0001 C CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:C_Small C3
U 1 1 58EE51CA
P 4150 6450
F 0 "C3" V 4050 6450 50  0000 C CNN
F 1 "1uF/10V/10%/X5R/C0603" V 4250 6450 30  0000 C CNN
F 2 "OLIMEX_RLC-FP:C_0603_5MIL_DWS" H 4150 6450 60  0001 C CNN
...
Wire Wire Line
	9900 4400 9900 4200
$Comp
L MOD-LCD2.8RTP_Rev_C:CONN_01X12 mUEXT1
U 1 1 6336899C
P 10800 4900
F 0 "mUEXT1" H 10550 5650 50  0000 L CNN
F 1 "FPV-WZA21-12-LF" H 10100 5550 50  0000 L CNN
F 2 "OLIMEX_Connectors-FP:FPV-WZB21-12-LF" H 10888 4676 50  0001 L CNN
...
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR021
U 1 1 6337B3BA
P 10800 5850
F 0 "#PWR021" H 10800 5600 50  0001 C CNN
F 1 "GND" H 10875 5700 50  0000 R CNN
...
Wire Wire Line
	10600 5300 9500 5300
Wire Wire Line
	10600 5400 9900 5400
Wire Wire Line
	10600 5500 9900 5500
Wire Wire Line
	10600 4500 9900 4500
Wire Wire Line
	9500 4600 10600 4600
Wire Wire Line
	10600 4700 9500 4700
Wire Wire Line
	10600 4800 9500 4800
Wire Wire Line
	10600 4900 9500 4900
Wire Wire Line
	10600 5000 9500 5000
Wire Wire Line
	10600 5100 9500 5100
Wire Wire Line
	10600 5200 9500 5200
$Comp
L MOD-LCD2.8RTP_Rev_C:P-MOS+DIOD FET1
U 1 1 639EDAB1
P 3400 6750
F 0 "FET1" H 2950 6800 60  0000 L CNN
F 1 "WPM2015-3/TR" H 2450 6650 60  0000 L CNN
F 2 "OLIMEX_Transistors-FP:SOT23" H 3616 6619 60  0001 L CNN
...
EndData
$EndBitmap
Text Notes 8900 1500 0    80   Italic 16
I2C Address: \n0x90(write)\n0x91(read)\n7-bit address is: 0x48
Wire Wire Line
	6050 2600 5700 2600
Wire Wire Line
	6050 2900 5250 2900
...
Wire Wire Line
	3500 5650 1100 5650
Text Notes 4200 1800 0    80   Italic 16
I2C Address: \n0x9A(write)\n0x9B(read)\n7-bit address is: 0x4D
Wire Wire Line
	2500 4550 2500 4650
$Comp
L MOD-LCD2.8RTP_Rev_C:GND #PWR0101
U 1 1 63917E10
P 2500 4650
